((CSS_TEXT, VERSION) => {
  ...
  const CODEX_THEME_VARIABLES = [
    ...
    "--color-background-control-opaque", "--color-background-composer-action-bar",
    ...
    "--color-background-mode-toggle-selected", "--color-background-mode-toggle-track",
    ...
    "--color-border-mode-toggle-selected",
    ...
    "--color-text-foreground-tertiary", "--color-text-mode-toggle-inactive", "--color-text-on-accent",
    "--shadow-mode-toggle-selected",
  ...
  function buildCodexTokens(palette, settings) {
    ...
    return {
      ...
      // Codex 26.9+ moved the Home utility strip and Chat/Work switcher onto
      // dedicated semantic tokens. Leaving these native makes a dark generated
      // skin inherit the app's light cream surfaces after an app update.
      "--color-background-composer-action-bar": rgba(palette.input, Math.min(0.98, opacity + 0.08)),
      ...
      "--color-background-mode-toggle-track": rgba(palette.surfaceStrong, Math.min(0.98, opacity + 0.08)),
      "--color-background-mode-toggle-selected": rgba(palette.elevated, Math.min(0.995, opacity + 0.16)),
      ...
      "--color-border-mode-toggle-selected": palette.borderHeavy,
      ...
      "--color-text-mode-toggle-inactive": secondary,
      "--color-text-on-accent": palette.accentInk,
      "--shadow-mode-toggle-selected": `0 8px 24px ${rgba(palette.bg, 0.32)}`,
